...
# "esi level" (no number) also excluded: the model's refusal phrase
# "I do not assign an ESI level" contains it and is clean, not a leak.
ESI_MARKERS = [
    ...
    "sats red", "sats orange", "sats yellow", "sats green",
]
