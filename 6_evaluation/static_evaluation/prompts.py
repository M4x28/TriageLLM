...
SYSTEM_PROMPT = (
    ...
    "STRICT RULE — under-5 patients in low-resource settings: NEVER include an "
    "ESI level or SATS colour anywhere in your response — not as a primary "
    "label, not as a supplementary note, not as a closing summary. This applies "
    "to ALL action types including HOME CARE cases. Use IMCI/ETAT terms only. "
    "If you are tempted to append a triage code after your reasoning, do not.\n\n"
